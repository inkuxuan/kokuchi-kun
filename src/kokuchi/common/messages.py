class Messages:
    ...
    class Discord:
        ...
        JOB_CANCELLED = "メッセージID {} の告知をキャンセルしました。"
        JOB_NOT_FOUND = "メッセージID {} は見つかりませんでした。"
        CMD_LIST_TITLE = "コマンド一覧"
        CMD_LIST_DESC = "予約されている告知の一覧を表示"
        CMD_CANCEL_DESC = "指定されたメッセージIDの告知をキャンセル"
        CMD_RELOAD_DESC = "設定とプロンプトの再読み込み（Bot管理者専用）"
